...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🧪 اختبار شامل – MyTwin API"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""

# ── 1. الحصول على توكن ──────────────────────
echo "📋 1. المصادقة..."
DEV_RESPONSE=$(curl -s -X POST "$BASE/api/dev/token" \
  -H "Content-Type: application/json" \
  -d '{"secret":"devsecret123","email":"sir.market7@gmail.com","password":"M#m2606.1307"}')

TOKEN=$(echo "$DEV_RESPONSE" | python3 -c "import sys,json; d=json.load(sys.stdin); print(d.get('token',''))" 2>/dev/null)

if [ -z "$TOKEN" ]; then
    echo "   ❌ فشل الحصول على توكن"
    echo "   رد: $DEV_RESPONSE"
    exit 1
fi

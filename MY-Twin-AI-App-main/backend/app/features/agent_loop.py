"""Agent Loop v5.1 – متوافق مع Unified Tool Registry."""
import logging, time
...
class AgentLoop:
    ...
    async def execute(
        self, plan: Dict[str, Any], user_id: str, message: str,
        emotion: Dict[str, Any], context_summary: str = "", lang: str = "ar",
    ) -> Dict[str, Any]:
...
logger.info("✅ Agent Loop v5.1 ready")
